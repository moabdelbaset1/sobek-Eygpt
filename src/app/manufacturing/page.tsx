            ...
            <div className="lg:col-span-5 flex flex-col gap-4">
              {qualityFeatures.map((feature, index) => (
                <button
                  ...
                  className={`relative group w-full flex items-center gap-5 p-6 rounded-2xl text-left transition-all duration-300 border ${activeFeature === index
                ...
                >
                  <div className={`w-12 h-12 rounded-xl flex items-center justify-center transition-colors ${activeFeature === index ? "bg-white/20 text-white" : "bg-gray-50 text-gray-600 group-hover:bg-gray-100" // REMOVED RED ACCENTS HERE
                    }`}>
