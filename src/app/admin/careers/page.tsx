                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex gap-4 mb-8">
                        <button
                            ...
                            className={`flex items-center gap-2 px-6 py-3 rounded-xl font-bold transition-all shadow-sm ${activeTab === 'jobs'
                        ...
                        >
                            ...
                            Jobs Management
                            <span className={`px-2 py-1 rounded-full text-xs font-bold ${activeTab === 'jobs' ? 'bg-white text-red-600' : 'bg-red-100 text-red-600'
                                }`}>{jobs.length}</span>
                        </button>
                        <button
                            onClick={() => setActiveTab('applications')}
                            className={`flex items-center gap-2 px-6 py-3 rounded-xl font-bold transition-all shadow-sm ${activeTab === 'applications'
                                    ? 'bg-red-600 text-white'
                                    : 'bg-white text-gray-700 hover:bg-gray-50 border border-gray-200'
                                }`}
                        >
                            ...
                            Applications
                            <span className={`px-2 py-1 rounded-full text-xs font-bold ${activeTab === 'applications' ? 'bg-white text-red-600' : 'bg-red-100 text-red-600'
