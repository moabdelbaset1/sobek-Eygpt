      ...
      <div className="flex-1 ml-72 p-10">
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="flex items-end justify-between">
            <div>
              <h1 className="text-3xl font-bold text-slate-800">Human Products</h1>
              <p className="text-slate-500 mt-2">Manage your human pharmaceutical products catalog</p>
            </div>
            <button
          ...
          <div className="space-y-6">
             {loading ? (
                <div className="flex flex-col items-center justify-center py-20">
                   ...
                   <p className="text-slate-500">Loading products catalog...</p>
                </div>
                        ...
                        >
                           ...
                           <div className="p-5 flex-1 flex flex-col">
                              ...
                              <div className="my-4 space-y-2 flex-1">
                                 ...
                                 <div className="flex items-center text-xs text-slate-500 bg-slate-50 p-2 rounded-lg">
                                    <span className="font-semibold text-slate-700 w-20">Dosage:</span>
                                    <span className="truncate">{product.dosage_form} ({product.strength})</span>
                                 </div>
                              </div>
                ...
                <div className="text-center py-20 bg-white rounded-3xl border border-dashed border-slate-200">
                   ...
                   <p className="text-slate-500 max-w-sm mx-auto mb-8">
                     {searchTerm ? `No matches found for "${searchTerm}"` : "Get started by adding your first human pharmaceutical product to the catalog."}
                   </p>
                   {searchTerm ? (
                      <button 
