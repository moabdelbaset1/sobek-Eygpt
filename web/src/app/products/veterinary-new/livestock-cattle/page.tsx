...
export default function LivestockCattlePage() {
  ...
  const loadProducts = async () => {
    try {
      setLoading(true);
      const data = await veterinaryProductsAPI.getByCategory('livestock-cattle');
      setProducts(data);
    } catch (error) {
      ...
      <div className="bg-gradient-to-r from-green-600 to-green-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold mb-2">🐄 Livestock & Cattle</h1>
              <p className="text-green-100">Medications for cattle, sheep, and goats</p>
            </div>
