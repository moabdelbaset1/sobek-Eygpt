...
export default function CompanionAnimalsPage() {
  ...
  const loadProducts = async () => {
    try {
      setLoading(true);
      const data = await veterinaryProductsAPI.getByCategory('companion-animals');
      setProducts(data);
    } catch (error) {
      ...
      <div className="bg-gradient-to-r from-purple-600 to-purple-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold mb-2">🐕 Companion Animals</h1>
              <p className="text-purple-100">Dogs, cats, and pet medications</p>
            </div>
